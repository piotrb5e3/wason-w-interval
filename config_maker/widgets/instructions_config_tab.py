...
class InstructionsConfigTab(QWidget):
    ...
    def init_ui(self):
        ...
        ig_instructions.textChanged.connect(self.controller.set_ig_instr)
        ...
        ig_pre_measuring.textChanged.connect(
            self.controller.set_ig_measuring_instr)
        ...
        igns_instructions.textChanged.connect(
            self.controller.set_ig_w_cs_training_instr)
        ...
        main_exp_instructions.textChanged.connect(
            self.controller.set_pre_exp_instr)
        ...
        main_exp_click_instructions.textChanged.connect(
        ...
        thanks_text.textChanged.connect(self.controller.set_thanks_text)
